================================================================================
    БИБЛИОТЕКА MICROSOFT FOUNDATION CLASS. Обзор проекта stl_network_ip_4_ip_6_udp_engine
===============================================================================

Это приложение stl_network_ip_4_ip_6_udp_engine автоматически создано с помощью мастера приложений. Это приложение демонстрирует основные принципы использования классов Microsoft Foundation; оно также может использоваться в качестве основы для написания собственных приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения stl_network_ip_4_ip_6_udp_engine.

stl_network_ip_4_ip_6_udp_engine.vcxproj
...
stl_network_ip_4_ip_6_udp_engine.vcxproj.filters
...
stl_network_ip_4_ip_6_udp_engine.h
    Это основной файл заголовка приложения.
    Он содержит прочие заголовки, относящиеся к проекту (включая Resource.h), а также объявляет класс приложения Cstl_network_ip_4_ip_6_udp_engineApp.

stl_network_ip_4_ip_6_udp_engine.cpp
    Это основной исходный файл приложения, в котором содержится класс приложения Cstl_network_ip_4_ip_6_udp_engineApp.

stl_network_ip_4_ip_6_udp_engine.rc
...
res\stl_network_ip_4_ip_6_udp_engine.ico
    Файл значка, используемый в качестве значка приложения. Этот значок включен с помощью основного файла ресурсов stl_network_ip_4_ip_6_udp_engine.rc.

res\stl_network_ip_4_ip_6_udp_engine.rc2
...
stl_network_ip_4_ip_6_udp_engineDlg.h, stl_network_ip_4_ip_6_udp_engineDlg.cpp — диалоговое окно
    Эти файлы содержат класс Cstl_network_ip_4_ip_6_udp_engineDlg. Этот класс определяет поведение главного диалогового окна приложения. Шаблон диалогового окна находится в файле stl_network_ip_4_ip_6_udp_engine.rc, который можно изменять с помощью Microsoft Visual C++.
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем stl_network_ip_4_ip_6_udp_engine.pch и файла предкомпилированных типов с именем StdAfx.obj.
...
stl_network_ip_4_ip_6_udp_engine.manifest
