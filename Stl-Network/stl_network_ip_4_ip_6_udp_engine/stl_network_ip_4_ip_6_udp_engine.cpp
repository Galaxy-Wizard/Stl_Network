...
// stl_network_ip_4_ip_6_udp_engine.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cstl_network_ip_4_ip_6_udp_engineApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание Cstl_network_ip_4_ip_6_udp_engineApp

Cstl_network_ip_4_ip_6_udp_engineApp::Cstl_network_ip_4_ip_6_udp_engineApp()
{
...
// Единственный объект Cstl_network_ip_4_ip_6_udp_engineApp

Cstl_network_ip_4_ip_6_udp_engineApp theApp;


// инициализация Cstl_network_ip_4_ip_6_udp_engineApp

BOOL Cstl_network_ip_4_ip_6_udp_engineApp::InitInstance()
{
	...
	SetRegistryKey(_T("stl_network_ip_4_ip_6_udp_engine"));

	Cstl_network_ip_4_ip_6_udp_engineDialog dlg;
	m_pMainWnd = &dlg;
